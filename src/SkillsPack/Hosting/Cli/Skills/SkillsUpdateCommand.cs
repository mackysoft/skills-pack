...
internal sealed class SkillsUpdateCommand
{
    ...
    [Command(SkillsPackCommandNames.UpdateSubcommand)]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var target = SkillsTargetOptionResolver.Resolve(
            SkillsPackCommandNames.SkillsUpdate,
            host,
            scope,
            repoRoot,
            targetDir,
        ...
        {
            var packageErrorResult = SkillsCommandResultFactory.CreateSkillFailure(SkillsPackCommandNames.SkillsUpdate, packagesResult.Failure!);
